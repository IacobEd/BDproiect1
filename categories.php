...
<div class="super_container">
			...
			<div class="row">
				<div class="col">
					...
					<div class="product_grid">
                        <?php include 'TriggersNProcedure.php'
						...
						<div class="product">
							...
							<div class="product_image"><img src=$row['image'] alt=""></div>
							<div class="product_extra product_new"><a href="categories.php">New</a></div>
							<div class="product_content">
								<div class="product_title"><a href="product.php"><?php echo $row['name']?></a></div>
    ...
    <?php
    include 'TriggersNProcedure.php';
    $msg = '';
    if(isset($_POST["submit"])){
        $target = "./images/".md5(uniqid(time())).basename($_FILES['image']['productName']);
        $_POST['img'] = $target;
        if(move_uploaded_file($_FILES['image']['tmp_name'], $target))
            dbs::getInstance()->insertProduct($_POST);
        else
            $msg = "<br>Error<br>";
    }
    echo $msg;
